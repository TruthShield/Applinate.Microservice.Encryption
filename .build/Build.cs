...
class Build : NukeBuild
{
    ...
    static string Version = new Version(0, 5, 1).ToString();
    ...
    Target Pack => _ => _
      ...
      {
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.Encryption.Abstractions"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
          ...
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.Encryption.Core"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
          ...
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.Encryption.None"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
